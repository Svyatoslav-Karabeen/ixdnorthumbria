<?php
/**
 * HOME PAGE >> Reveal environment
 *
 * This is the template to display information about our course for the reveal show.
 *
    ...
    <div id="hero-container">
        ...
        <div class="hero-container">
            <div class="text-wrapper">
                <h1 class="text-main">Hello, Newcastle!</h1>
                <p>We're pleased to invite you to the annual Interaction Design reveal show, held at Northumbria University.</p>
                <p>Feel free to come along and visit our variety of work.</p>
            </div>
