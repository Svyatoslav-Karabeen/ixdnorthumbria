...
<header>
	...
	<div class="menu-wrapper">
	    ...
	    <div id="nav-years">
	        <button class="button-none" id="nav-years-button">previous years</button>
	        <div class="dropdown-body" id="nav-years-list">
				<div class="dropdown-arrow"></div>
	            <ul>
	                <li><a class="dropdown-link" href="<?php echo url . 'previous/2017' ?>">2017</a></li>
	                <li><a class="dropdown-link" href="<?php echo url . 'previous/2016' ?>">2016</a></li>
	                <li><a class="dropdown-link" href="<?php echo url . 'previous/2015' ?>">2015</a></li>
	                <li><a class="dropdown-link" href="<?php echo url . 'previous/2014' ?>">2014</a></li>
	            </ul>
	        </div>
	    </div>
	</div>
