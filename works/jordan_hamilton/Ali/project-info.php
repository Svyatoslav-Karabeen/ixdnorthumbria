...
$projectName        = 'Ali';
$projectType        = 'Hybrid';
$projectScope       = array('Logo Design', 'Packaging design', 'Interaction Design', 'Prototype', 'Communication', );
 ...
 *                    Otherwise, just delete the placeholder and leave it blank.
 *
 * $hasDesDoc       – would you like to add a link to your design documentation
 *                    at the end of the project? Bear in mind, it's an additional
 *                    material and cannot be used as a replacement of any of
 *                    project's sections. Replace the placeholder with 'yes' or
 *                    'no' only!
 *
 * $DesDocLink      – if yes, please provide a link to your design documentation.
 *                    Otherwise, just delete the placeholder and leave it blank.
 *
 **/

$hasBannerVideo     = 'Yes';
$BannerVideoURL     = 'https://youtu.be/_TTk1nlkhX0';

$hasFinalSlider     = 'Yes';
$hasFinalVideo      = 'Yes';
$FinalVideoURL      = 'assets/prototypevideo.pdf';

$hasDesDoc          = 'Yes';
$DesDocLink         = 'assets/desdoc.pdf';
